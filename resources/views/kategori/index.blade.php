        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <a href="{{ route('kategori.create') }}">
                    <button class="bg-gray-900 hover:bg-black hover:text-red-700 text-white font-bold py-2 px-4 rounded">
                        Tambah Kategori
                    </button>
                </a>
                                ...
                                <tr class="text-center align-middle">
                                    ...
                                    <td>
                                        <a href="{{ route('kategori.detail', $kategori->id_kategori) }}" class="text-blue-500">
                                            <button type="submit" class="bg-red-400 hover:bg-white hover:text-black text-white font-bold py-2 px-4 rounded">
                                                Detail
                                               </button>
                                        </a>
