<x-app-layout>
    ...
    <div class="pt-10 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-slate-400 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <form>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                ...
                                value="{{ old('keterangan', $kategori->updated_at)}}">
                                </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                ...
                                value="{{ old('keterangan', $kategori->created_at)}}">
                                </div>
