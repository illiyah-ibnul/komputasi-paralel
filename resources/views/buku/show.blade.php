        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <a href="{{ route('buku.index') }}">
                    <button class="bg-gray-900 hover:bg-green-400 hover:text-black text-white font-bold py-2 px-4 rounded">
                        Kembali
                    </button>
                </a>
                <div id='recipients' class="p-8 mt-6 lg:mt-0 text-white bg-red-600 dark:bg-gray-800 rounded shadow">
                    <form>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                @if ($buku->cover)
                                    <img src="{{ asset('storage/' . $buku->cover) }}" alt="Cover Buku" class="w-32 rounded-md border-separate border-2 border-amber-400">
                                @else
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                ...
                                id="update" name="update" type="text"
                                value="{{ old('keterangan', $buku->updated_at)}}">
                                </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input disabled class="form-input block w-full text-black focus:bg-gray-500 rounded-md"
                                id="create" name="create" type="text"
                                value="{{ old('keterangan', $buku->created_at)}}">
                                </div>
